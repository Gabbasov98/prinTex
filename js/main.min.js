...
$(".service-card__title").click(function () {
    if(window.innerWidth <= 992){
        // $(".service-card").removeClass("_active")
        // $(this).parents(".service-card").addClass("_active")

        if($(this).parents(".service-card").hasClass("_active")){
            $(".service-card").removeClass("_active")
        } else{
            $(".service-card").removeClass("_active")
            $(this).parents(".service-card").addClass("_active")
...
function worksSlider() {
    var swiper = new Swiper('.works-slider .swiper-container', {
        slidesPerView: 5,
        spaceBetween: 17,
        watchSlidesProgress: true,
        preventClicks :true,
...
$(".portfolio-card__img").click(function () {
    $(this).parents(".portfolio-card").addClass("_zoom")
    $("body").addClass("fixed-body")
})
$("._close-portfolio").click(function () {
    $(".portfolio-card").removeClass("_zoom")
